...
#'
#' @usage ca_future_worldclim(var, res, gcm, ssp, interval, path, return_stack)
#'
...
#' Check https://www.worldclim.org for all available GCM. Those are, "ACCESS-CM2", "ACCESS-ESM1-5", "BCC-CSM2-MR", "CanESM5",
...
ca_future_worldclim <- function(var, res, gcm, ssp, interval, path, return_stack) {
