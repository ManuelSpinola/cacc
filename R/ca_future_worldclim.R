...
#' @examples
#'
#' climate <- ca_future_worldclim(variable = "tmax", resolution = 10, gcm = "ACCESS-CM2", ssp = "ssp126", interval = "2041-2060")
#'
#' @export

library(stars)

ca_future_worldclim <- function(variable, resolution, gcm, ssp, interval) {
